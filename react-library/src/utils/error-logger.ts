 ...
 * Provides consistent error logging across applications
 * Framework-agnostic and extensible for any logging backend
 */
...
class ErrorLoggerClass {
  ...
  /**
   * Register a logger adapter (e.g., Firebase, Sentry, custom API)
   */
