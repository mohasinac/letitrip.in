...
export interface AutoBidSetupProps {
  auctionId: string;
  currentBid: number;
  reservePrice?: number;
  minIncrement?: number;
...
/**
 * AutoBidSetup Component
 *
 * Allows users to set up automatic bidding with a maximum bid amount.
 * Used on auction detail pages to enable hands-off bidding.
 *
 * Features:
 * - Three states: setup button, setup form, active indicator
 * - Maximum bid input with validation
 * - Quick select buttons with suggested amounts
 * - Auto-bid explanation and rules
 * - Active state with cancel option
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <div>
          <FormLabelComponent htmlFor="autobid-max-amount">
            Maximum Bid Amount
          </FormLabelComponent>
