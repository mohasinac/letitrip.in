...
describe("TableCheckbox", () => {
  ...
  it("does not call onChange when disabled", () => {
    const onChange = vi.fn();
    render(<TableCheckbox checked={false} onChange={onChange} disabled={true} />);
  ...
  it("renders with disabled state", () => {
    render(<TableCheckbox checked={false} onChange={() => {}} disabled={true} />);
  ...
  it("sets indeterminate state", () => {
    render(<TableCheckbox checked={false} onChange={() => {}} indeterminate={true} />);
  ...
  it("updates indeterminate state when prop changes", () => {
    const { rerender } = render(
      <TableCheckbox checked={false} onChange={() => {}} indeterminate={false} />
    );
    
    const checkbox = screen.getByRole("checkbox") as HTMLInputElement;
    expect(checkbox.indeterminate).toBe(false);
    
    rerender(<TableCheckbox checked={false} onChange={() => {}} indeterminate={true} />);
    expect(checkbox.indeterminate).toBe(true);
  });
  ...
  it("uses custom label when provided", () => {
    render(<TableCheckbox checked={false} onChange={() => {}} label="Custom label" />);
  ...
  it("renders with touch-friendly minimum size", () => {
    const { container } = render(<TableCheckbox checked={false} onChange={() => {}} />);
  ...
  it("maintains checked state through indeterminate changes", () => {
    ...
    rerender(<TableCheckbox checked={true} onChange={() => {}} indeterminate={true} />);
    expect(checkbox.checked).toBe(true);
    expect(checkbox.indeterminate).toBe(true);
  });

  it("can be checked while disabled", () => {
    render(<TableCheckbox checked={true} onChange={() => {}} disabled={true} />);
