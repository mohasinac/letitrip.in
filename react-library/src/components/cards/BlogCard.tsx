...
export const BlogCard: React.FC<BlogCardProps> = ({
  ...
  const linkProps = {
    href: `/blog/${slug}`,
    className:
      "group block bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-200",
  };
