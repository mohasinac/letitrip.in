 ...
 *
 * Displays event winners with rankings in a podium-style layout.
 * Used to showcase competition results and achievements.
 *
 * Features:
 * - Top 3 podium display with special styling
 * - Rank icons (trophy, medal, award) for top positions
 * - Winner images, names, and descriptions
 * - Score display with optional points
 * - Responsive design (stacks on mobile)
 * - Dark mode support
 * - Customizable title and scoring
 *
 * @example
 * ```tsx
 * <WinnersSection
