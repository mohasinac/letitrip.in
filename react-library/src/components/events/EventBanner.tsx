 ...
 * Used as the main header on event detail pages.
 *
 * Features:
 * - Full-width image background with overlay
 * - Event details display (date, location, participants)
            ...
            <div className="flex items-start gap-3 text-white">
              ...
              <div>
                ...
                <div className="font-medium">
                  <DateDisplayComponent date={event.startDate} format="full" />
                </div>
                <div className="text-sm text-gray-300">
                  to <DateDisplayComponent date={event.endDate} format="full" />
                </div>
              </div>
            </div>
