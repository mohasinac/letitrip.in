...
import { formatPrice, formatDate, cn, validateEmail } from "./dist/utils/index.js";
...
console.log("- validateEmail:", typeof validateEmail === "function" ? "✓" : "✗");
...
console.log("- FormPhoneInput:", typeof FormPhoneInput === "function" ? "✓" : "✗");
console.log("- FormCurrencyInput:", typeof FormCurrencyInput === "function" ? "✓" : "✗");
console.log("- FormDatePicker:", typeof FormDatePicker === "function" ? "✓" : "✗");
...
console.log("- useDebouncedCallback:", typeof useDebouncedCallback === "function" ? "✓" : "✗");
console.log("- useThrottle:", typeof useThrottle === "function" ? "✓" : "✗");
console.log("- useLocalStorage:", typeof useLocalStorage === "function" ? "✓" : "✗");
console.log("- useMediaQuery:", typeof useMediaQuery === "function" ? "✓" : "✗");
...
console.log("- useIsTouchDevice:", typeof useIsTouchDevice === "function" ? "✓" : "✗");
console.log("- useViewport:", typeof useViewport === "function" ? "✓" : "✗");
console.log("- useBreakpoint:", typeof useBreakpoint === "function" ? "✓" : "✗");
