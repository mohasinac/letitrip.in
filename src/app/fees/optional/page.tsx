        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border dark:border-gray-700 p-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            {services.map((service) => (
              <div key={service.title} className="border dark:border-gray-700 rounded-lg p-6">
                ...
                <div className="mb-4 border-t dark:border-gray-700 pt-4">
                  ...
                  <div className="space-y-2">
                    {service.pricing.map((plan) => (
                      ...
                      >
                        <span className="text-gray-700 dark:text-gray-300">{plan.duration}</span>
          ...
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 mb-8">
            <h3 className="font-bold text-gray-900 dark:text-white mb-4">🎁 Package Deals</h3>
          ...
          <div className="border-t dark:border-gray-700 pt-6">
            <h3 className="font-bold text-gray-900 dark:text-white mb-4">How to Purchase</h3>
