    ...
    const mockWishlistItems: WishlistItem[] = [
      {
        ...
        slug: "beyblade-burst-pro-dragon-storm",
      },
      {
        id: "2",
        ...
        slug: "metal-fight-lightning-l-drago",
      },
      {
        id: "3",
        ...
        category: "Beyblade X",
        inStock: true,
        addedAt: "2024-01-15T14:22:00Z",
        slug: "beyblade-x-xcalibur-sword",
      },
      {
        id: "4",
        ...
        slug: "beyblade-stadium-thunder-dome",
      },
      {
        id: "5",
        ...
        category: "Launchers",
        inStock: true,
        addedAt: "2024-01-10T12:30:00Z",
        slug: "launcher-set-power-grip-pro",
      },
      {
        id: "6",
        name: "Beyblade Parts Collection Kit",
        price: 39.99,
        image: "/images/parts-1.jpg",
        category: "Parts & Accessories",
        inStock: false,
        addedAt: "2024-01-08T09:15:00Z",
        slug: "beyblade-parts-collection-kit",
      },
    ];
          ...
          {wishlistItems.length > 0 ? (
            ...
            <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
              ...
              <p className="mt-1 text-sm text-gray-500">
                Save items you love to buy them later. Just click the heart icon
                on any product.
              </p>
              <div className="mt-6">
                <Link href="/products" className="btn btn-primary">
