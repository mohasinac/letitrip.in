    ...
    <PreOrderDetailView
      ...
      renderInfo={(isLoading) =>
        isLoading ? (
          ...
          <Stack gap="md">
            <Heading level={2}>Pre-Order Item</Heading>
            <Text variant="secondary">Product details, availability window, and reservation info will appear here once the data layer is connected.</Text>
          </Stack>
        )
      }
      renderBuyBar={() => (
