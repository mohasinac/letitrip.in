...
function TagInput({
  ...
  return (
    <Stack gap="xs">
      ...
      <Row gap="xs" wrap>
        {values.map((v) => (
          <Div textWeight="medium" textSize="xs" 
            key={v}
            className="inline-flex items-center gap-1 bg-[color:var(--appkit-color-surface-elevated,theme(colors.zinc.100))] px-2.5" padding="y-2xs" rounded="full"
          >
            {v}
            <Button
              type="button"
