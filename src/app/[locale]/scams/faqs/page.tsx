          ...
          <Container size="xl">
            <Stack gap="sm">
              <Row gap="sm" align="center">
                <Span className="flex h-10 w-10 items-center justify-center bg-[color:var(--appkit-color-warning,theme(colors.amber.500))]/10 text-[color:var(--appkit-color-warning,theme(colors.amber.600))]" rounded="lg">
