...
import { getBrandForDetail, renderBrandOg, safeRead } from "@mohasinac/appkit/server";
...
export default async function Image({ params }: Props) {
  ...
  const doc = await safeRead(() => getBrandForDetail(slug), {
    route: "/brands/[slug]",
    key: "categories.getBrandForDetail",
    fallback: null,
  });
  return new ImageResponse(
    renderBrandOg(doc, { siteName: SEO_CONFIG.siteName ?? "LetItRip", baseUrl: SEO_CONFIG.siteUrl }),
    { ...size },
  );
}
