    ...
    <Stack padding="y-lg" gap="md">
      <Stack className="border border-success/20" surface="success-surface" padding="md" gap="sm" rounded="2xl">
        <Row align="center" gap="sm">
          <Span color="inverse" weight="semibold" className="inline-flex items-center bg-success text-[11px] tracking-wide" padding="pill-sm" rounded="full" transform="uppercase">
            Confirmed
          </Span>
