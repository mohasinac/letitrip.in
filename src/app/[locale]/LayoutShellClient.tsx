    ...
    newsletterSlot: (
      ...
      >
        ...
        <div className="flex gap-2" data-section="layoutshellclient-div-6">
          ...
          <button
            type="submit"
            className="flex-shrink-0 rounded-lg bg-primary-500 hover:bg-primary-600 px-4 py-2 text-sm font-medium text-zinc-900 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
            Subscribe
          </button>
        </div>
