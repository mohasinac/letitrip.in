...
export default function Page() {
  ...
  return (
    <Div className="mx-auto max-w-2xl">
      ...
      {loadError && (
        <Div className="mb-4 border border-error/20 bg-error-surface px-4 py-3 text-sm text-error" rounded="lg">
      ...
      <Stack gap="md" surface="card" padding="md">
        ...
        <Div className="border border-warning/20 bg-warning-surface px-3 py-2 text-xs text-warning" rounded="lg">
...
function renderFeedbackBanners({ saveError, saveSuccess, currentSlug }: {
  ...
  return (
    <>
      ...
      {saveSuccess && (
        <Div className="border border-success/20 bg-success-surface px-3 py-2 text-sm text-success" rounded="lg">
