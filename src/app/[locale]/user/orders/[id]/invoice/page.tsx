  ...
  return (
    <>
      ...
      <Row
        ...
        align="center"
        gap="md"
        className="print:hidden sticky z-[var(--appkit-z-dropdown)] px-6 py-3 bg-white dark:bg-slate-900 border-b border-zinc-200 dark:border-slate-700"
      ...
      <Div className="max-w-2xl mx-auto px-6 py-10 print:px-0 print:py-0 print:max-w-none">
        ...
        {/* items — native table required for consistent print rendering */}
