...
export default function RegisterPage() {
  ...
  const handleGoogleRegister = async () => {
    ...
    try {
      ...
      // Wait a moment for the auth context to process the state change
      // This ensures the user is properly set up before redirecting
      await new Promise((resolve) => setTimeout(resolve, 1000));

      // Manual redirect if needed (the auth listener should handle this)
      router.push(redirect || "/");
    } catch (error: any) {
