    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      ...
      <div className="mb-6 p-4 bg-blue-50 rounded-lg">
        ...
        <ul className="text-sm space-y-1">
          ...
          <li>✅ Asynchronous validation for email and username availability</li>
        ...
        <div className="mt-3 text-sm text-gray-700">
          ...
          <p>Taken emails: admin@example.com, user@example.com, test@example.com</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {validatingFields.username && (
            <p className="text-blue-500 text-sm mt-1">Checking username availability...</p>
          )}
        </div>
