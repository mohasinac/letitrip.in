        ...
        <div className="p-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <Link
                href="/products"
                className="px-4 py-2 bg-gray-50 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors text-center"
              >
                Products
              </Link>
              <Link
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <Link
              href="/search"
              className="flex items-center justify-center gap-2 w-full px-4 py-2 border-2 border-gray-300 text-gray-700 rounded-lg text-sm font-medium hover:border-blue-500 hover:text-blue-600 transition-colors"
            >
