/**
 * Bids API â€” Collection
 *
 * GET  /api/bids?productId=... â€” List bids for a product (public)
 * POST /api/bids              â€” Place a new bid (auth required)
 */
...
export const POST = createApiHandler<(typeof placeBidSchema)["_output"]>({
  ...
  handler: async ({ user, body }) => {
    ...
    // â”€â”€ Write to Realtime DB for live bid streaming â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    try {
