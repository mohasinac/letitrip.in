 ...
 * this avoids one URL navigation per checkbox tick.
 *
...
export function usePendingFilters({
  ...
  // Parse a comma-separated URL param value into a string[] (empty string → [])
  ...
  // Initialise pending from the current URL
  ...
  const reset = useCallback(() => {
    // Revert pending to the current URL state
