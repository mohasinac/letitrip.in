...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: String(ROUTES.ADMIN.FEATURES),   label: "Feature Badges" },
      { href: String(ROUTES.ADMIN.BUNDLES),    label: "Bundles"    },
      { href: String(ROUTES.ADMIN.PRIZE_DRAWS), label: "Prize Draws" },
