...
export const UI_LABELS = {
  ...
  CHECKOUT: {
    TITLE: "Checkout",
    // Step indicator
    STEP_LABELS: [STR_SHIPPING_ADDRESS, "Extras & fees", "Payment"] as readonly string[],
    STEP_ADDRESS: STR_SHIPPING_ADDRESS,
    STEP_EXTRAS: "Extras & fees",
    STEP_PAYMENT: "Payment",
    // Address step
    SELECT_ADDRESS: "Select Shipping Address",
    NO_ADDRESSES: STR_NO_SAVED_ADDRESSES,
    ADD_ADDRESS: "Add a New Address",
    // Leads to the extras step now, not straight to payment.
    ADDRESS_CONTINUE_BTN: "Continue",
    SHIPPING_TO: "Shipping to",
    ORDER_SUMMARY_HEADING: "Order Summary",
    ORDER_SUMMARY_TOTAL: "Total",
    // Extras & fees step
    EXTRAS_HEADING: "Add-ons & fees",
    EXTRAS_SUBLABEL: "Step 2 of 3 — Add-ons & fees",
    EXTRAS_INTRO: "Optional extras are chosen per seller, because each seller ships and bills separately.",
    EXTRAS_CONTINUE_BTN: "Continue to payment",
    EXTRAS_BACK_BTN: "Back",
    EXTRAS_NO_ADDONS_NOTE: "This store isn't offering any paid extras right now.",
    EXTRAS_NOTHING_SELECTED_NOTE: "Nothing from this seller is selected for checkout.",
    EXTRAS_FEES_HEADING: "What you'll pay",
    FEES_UNAVAILABLE_NOTE: "We couldn't calculate shipping & fees just now. Your total will be confirmed before payment.",
    FEES_PENDING_NOTE: "Shipping & fees are calculated once you pick an address.",
    FEES_CALCULATING_NOTE: "Calculating shipping & fees…",
    SELLER_FEES_UNAVAILABLE_NOTE: "We couldn't load this seller's fees. Your choices are saved and will be charged correctly.",
    NOTHING_PAYABLE_HEADING: "There's nothing payable here",
    NOTHING_PAYABLE_BODY: "Select the items you want to buy in your cart, then come back.",
    NOTHING_PAYABLE_CTA: "Back to cart",
    LANE_MISMATCH_NOTE: "That link pointed at a different part of your cart, which is no longer payable.",
    // Payment step
  ...
  SELLER_PAYOUTS: {
    PAGE_TITLE: "Payouts",
    PAGE_SUBTITLE: "Manage your earnings and payout requests",
    ...
    NO_PAYOUTS_DESC: "Request a payout once you have delivered orders",
    STATUS_PENDING: "Pending",
    STATUS_PROCESSING: "Processing",
    STATUS_COMPLETED: "Completed",
    STATUS_FAILED: "Failed",
    PAYMENT_METHOD_BANK: "Bank Transfer",
    PAYMENT_METHOD_UPI: "UPI",
    PLATFORM_FEE: (rate: number) => `Platform fee: ${rate * 100}%`,
    GROSS_AMOUNT: "Gross Amount",
    NET_AMOUNT: "Net Payout",
    ...
    ALREADY_PENDING: "You have a pending payout request",
    NO_EARNINGS: "No available earnings to withdraw",
  },
