...
export const ADMIN_SETTINGS_TABS: Tab[] = [
  { id: "general", label: "General", href: "/admin/settings", icon: "settings" },
  { id: "payment", label: "Payment", href: "/admin/settings/payment", icon: "credit-card" },
...
export const ADMIN_BLOG_TABS: Tab[] = [
  ...
  { id: "create", label: "Create Post", href: "/admin/blog/create", icon: "plus" },
  { id: "categories", label: "Categories", href: "/admin/blog/categories", icon: "folder" },
...
export const ADMIN_AUCTIONS_TABS: Tab[] = [
  ...
  { id: "moderation", label: "Moderation", href: "/admin/auctions/moderation", icon: "shield" },
];
...
export const ADMIN_CONTENT_TABS: Tab[] = [
  ...
  { id: "hero-slides", label: "Hero Slides", href: "/admin/hero-slides", icon: "image" },
  { id: "featured-sections", label: "Featured Sections", href: "/admin/featured-sections", icon: "star" },
  { id: "categories", label: "Categories", href: "/admin/categories", icon: "folder-tree" },
];

// Admin Support Tabs
export const ADMIN_SUPPORT_TABS: Tab[] = [
  { id: "all", label: "All Tickets", href: "/admin/support-tickets", icon: "life-buoy" },
];

// Seller Products Tabs
export const SELLER_PRODUCTS_TABS: Tab[] = [
  { id: "all", label: "All Products", href: "/seller/products", icon: "package" },
  { id: "create", label: "Add Product", href: "/seller/products/create", icon: "plus" },
];

// Seller Auctions Tabs
export const SELLER_AUCTIONS_TABS: Tab[] = [
  { id: "all", label: "All Auctions", href: "/seller/auctions", icon: "gavel" },
  { id: "create", label: "Create Auction", href: "/seller/auctions/create", icon: "plus" },
];

// Seller Orders Tabs
export const SELLER_ORDERS_TABS: Tab[] = [
  { id: "all", label: "All Orders", href: "/seller/orders", icon: "shopping-cart" },
  { id: "pending", label: "Pending", href: "/seller/orders?status=pending", icon: "clock" },
  { id: "completed", label: "Completed", href: "/seller/orders?status=completed", icon: "check" },
];

// Seller Shop Management Tabs
export const SELLER_SHOP_TABS: Tab[] = [
  { id: "shops", label: "My Shops", href: "/seller/my-shops", icon: "store" },
  { id: "create", label: "Create Shop", href: "/seller/my-shops/create", icon: "plus" },
];

// User Settings Tabs
export const USER_SETTINGS_TABS: Tab[] = [
  { id: "profile", label: "Profile", href: "/user/settings", icon: "user" },
  { id: "security", label: "Security", href: "/user/settings/security", icon: "shield" },
  { id: "notifications", label: "Notifications", href: "/user/settings/notifications", icon: "bell" },
];

// User Orders Tabs
export const USER_ORDERS_TABS: Tab[] = [
  { id: "all", label: "All Orders", href: "/user/orders", icon: "package" },
  { id: "active", label: "Active", href: "/user/orders?status=active", icon: "clock" },
  { id: "completed", label: "Completed", href: "/user/orders?status=completed", icon: "check" },
];
...
export const USER_AUCTIONS_TABS: Tab[] = [
  ...
  { id: "won", label: "Won Auctions", href: "/user/won-auctions", icon: "trophy" },
];
