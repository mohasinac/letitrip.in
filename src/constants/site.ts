...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://letitrip.in';
export const API_URL = process.env.NEXT_PUBLIC_API_URL || `${SITE_URL}/api`;

// Site Metadata
export const SITE_DESCRIPTION = 'Modern auction and e-commerce platform for India';
export const SITE_KEYWORDS = 'auction, e-commerce, online shopping, bidding, India';
...
// URLs
export const SOCKET_URL = process.env.NEXT_PUBLIC_SOCKET_URL || 'https://beyblade-socket-server.onrender.com';

// Application Configuration
export const COUPON_PREFIX = process.env.COUPON_CODE_PREFIX || 'LT';
export const COUPON_LENGTH = parseInt(process.env.COUPON_CODE_LENGTH || '8', 10);
