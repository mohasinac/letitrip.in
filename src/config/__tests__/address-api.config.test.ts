...
describe("Address API Config", () => {
  describe("POSTAL_PINCODE_CONFIG", () => {
    it("should have correct basic properties", () => {
      ...
      expect(POSTAL_PINCODE_CONFIG.baseUrl).toBe(
    ...
    it("should have valid rate limits", () => {
      ...
      expect(POSTAL_PINCODE_CONFIG.rateLimit.requestsPerMinute).toBeGreaterThan(
        0
      );
    ...
    it("should have documentation URL", () => {
      expect(POSTAL_PINCODE_CONFIG.docs).toBe(
  ...
  describe("Rate limiting", () => {
    it("should have reasonable daily limits", () => {
      expect(
        POSTAL_PINCODE_CONFIG.rateLimit.requestsPerDay
      ).toBeLessThanOrEqual(100000);
      expect(ZIPPOPOTAM_CONFIG.rateLimit.requestsPerDay).toBeLessThanOrEqual(
        100000
      );
    });

    it("should have minute limits that make sense with daily limits", () => {
      const postalMinuteLimit =
        POSTAL_PINCODE_CONFIG.rateLimit.requestsPerMinute;
  ...
  describe("API specific features", () => {
    ...
    it("should identify international API", () => {
      expect(ZIPPOPOTAM_CONFIG.description.toLowerCase()).toContain(
        "international"
      );
    });
  });
