  ...
  return (
    <nav className="bg-gray-800 text-white py-3 px-4 sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-2 text-sm cursor-pointer hover:bg-gray-700 px-3 py-2 rounded">
          <MapPin className="w-4 h-4" />
          <div>
            <div className="text-xs text-gray-300">Deliver to</div>
            <div className="font-semibold">
              {DEFAULT_LOCATION.country} - {DEFAULT_LOCATION.pincode}
            </div>
          </div>
        </div>
