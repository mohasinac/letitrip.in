...
describe("FAQItem", () => {
  ...
  describe("Default Open State", () => {
    it("renders answer immediately when defaultOpen is true", () => {
      render(<FAQItem question={mockQuestion} answer={mockAnswer} defaultOpen={true} />);
    ...
    it("defaults to closed when defaultOpen is false", () => {
      render(<FAQItem question={mockQuestion} answer={mockAnswer} defaultOpen={false} />);
  ...
  describe("Styling", () => {
    ...
    it("applies correct answer styling", () => {
      const { container } = render(
        <FAQItem question={mockQuestion} answer={mockAnswer} defaultOpen={true} />
      );
