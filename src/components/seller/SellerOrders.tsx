              ...
              items: [
                {
                  id: "item1",
                  productId: "prod1",
                  productName: "Beyblade Burst Turbo",
              ...
              items: [
                {
                  id: "item2",
                  productId: "prod2",
                  productName: "Stadium Pro Arena",
                  productImage: "/images/stadium1.jpg",
                  sku: "STA001",
                  price: 4999,
                  quantity: 1,
                  total: 4999,
                ...
                <div className="space-y-2">
                  {order.items.map((item) => (
                    <div key={item.id} className="flex items-center space-x-3 text-sm">
                      ...
                      <span className="text-gray-900 font-medium ml-auto">{formatCurrency(item.total)}</span>
                    </div>
                  ))}
                </div>
