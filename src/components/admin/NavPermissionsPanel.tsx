...
/**
 * The nav-permissions editor, as a panel.
 *
 * It was `/admin/settings/navigation`'s whole page until W8 C2 folded it into
 * `/admin/settings/actions` — both toggle platform surfaces on and off into the
 * same `siteSettings` singleton, and both are `admin:settings:write`.
 */
export async function NavPermissionsPanel() {
  ...
  return (
    <Div>
      <Div className="mb-6">
        <Heading level={2} weight="semibold" size="xl">Navigation Permissions</Heading>
