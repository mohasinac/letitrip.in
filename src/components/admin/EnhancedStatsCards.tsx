...
export default function EnhancedStatsCards({
  ...
  const [animatedValues, setAnimatedValues] = useState<AdminStats | null>(null);
  ...
  useEffect(() => {
    ...
    Object.keys(stats).forEach((key) => {
      const statKey = key as keyof AdminStats;
      if (
          ...
          const interval = setInterval(() => {
            ...
            setAnimatedValues((prev) =>
              prev
                ? {
                    ...prev,
                    [statKey]: Math.round(currentValue),
                  }
                : null
            );
  ...
  const cards = [
    {
      ...
      priority: stats && stats.revenueChange < -10 ? "high" : "normal",
    },
    {
      name: "Total Orders",
      ...
      priority: stats && stats.pendingOrders > 50 ? "high" : "normal",
      badge:
    ...
    },
    {
      ...
      value: animatedValues ? formatNumber(animatedValues.totalCustomers) : "0",
    ...
    {
      name: "Products",
      value: animatedValues ? formatNumber(animatedValues.totalProducts) : "0",
      change: 0, // Products don't have a change metric
      icon: ChartBarIcon,
      color: "bg-orange-500",
      bgGradient: "from-orange-400 to-orange-600",
      description: "Total products",
      priority: stats && stats.lowStockProducts > 10 ? "high" : "normal",
      badge:
