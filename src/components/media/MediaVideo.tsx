 ...
 * MediaVideo
 *
 * Tier 1 primitive for ALL video asset rendering (product demos, auction clips).
 * Replaces raw <video> elements across the app.
 *
 * Always fills its parent container — the parent must supply:
 *   position: relative  (or Tailwind `relative`)
 *   overflow: hidden    (or Tailwind `overflow-hidden`)
 *   an aspect-ratio / height to define the display area
 *
 * Usage:
