"use client";
/* eslint-disable lir/no-raw-html-elements, lir/no-raw-media-elements -- LR1-03: legacy raw HTML — migration tracked in crud-tracker.md Tier LR (row LR1-03) */

import { useState } from "react";

const CLS_LABEL = "block text-sm font-medium text-zinc-700 dark:text-zinc-300";
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        <label className={CLS_LABEL}>Display Name</label>
        <input
          type="text"
          value={displayName}
