...
export const ShopCardSkeleton: React.FC<ShopCardSkeletonProps> = ({
  ...
  return (
    <div className="block bg-white border border-gray-200 rounded-lg overflow-hidden animate-pulse">
      {/* Banner Skeleton */}
      {showBanner && !compact && <div className="relative h-32 bg-gray-200" />}
      ...
      >
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div
            ...
            } rounded-lg overflow-hidden flex-shrink-0 bg-gray-200 ${
          ...
          <div className="flex-1 min-w-0 space-y-2">
            ...
            {/* Location */}
            {!compact && <div className="h-3 bg-gray-200 rounded w-24" />}
          </div>

          {/* Follow Button Skeleton */}
          <div className="h-9 w-20 bg-gray-200 rounded-md flex-shrink-0" />
        </div>
