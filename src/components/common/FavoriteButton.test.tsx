...
describe("FavoriteButton", () => {
  ...
  describe("Basic Rendering", () => {
    ...
    it("shows remove from favorites title when favorited", () => {
      render(<FavoriteButton itemId="item1" itemType="product" initialIsFavorite />);
  ...
  describe("Icon States", () => {
    it("shows unfilled heart when not favorited", () => {
      const { container } = render(<FavoriteButton itemId="item1" itemType="product" />);
    ...
    it("shows filled heart when favorited", () => {
      const { container } = render(<FavoriteButton itemId="item1" itemType="product" initialIsFavorite />);
      const heart = container.querySelector("svg");
  ...
  describe("Sizes", () => {
    it("applies small size classes", () => {
      const { container } = render(<FavoriteButton itemId="item1" itemType="product" size="sm" />);
      const heart = container.querySelector("svg");
    ...
    it("applies large size classes", () => {
      const { container } = render(<FavoriteButton itemId="item1" itemType="product" size="lg" />);
      const heart = container.querySelector("svg");
  ...
  describe("Toggle Functionality", () => {
    ...
    it("calls onToggle callback with new state", async () => {
      ...
      render(<FavoriteButton itemId="item1" itemType="product" onToggle={onToggle} />);
  ...
  describe("Authentication", () => {
    it("redirects to login when user not authenticated", () => {
      ...
      window.location = { href: "", pathname: "/products/123" } as any;
      
      render(<FavoriteButton itemId="item1" itemType="product" />);
      fireEvent.click(screen.getByRole("button"));
      
      expect(window.location.href).toBe("/auth/login?redirect=/products/123");
    });
  ...
  describe("Custom Styling", () => {
    it("applies custom className", () => {
      render(<FavoriteButton itemId="item1" itemType="product" className="custom-class" />);
      expect(screen.getByRole("button")).toHaveClass("custom-class");
    });

    it("preserves base classes with custom className", () => {
      render(<FavoriteButton itemId="item1" itemType="product" className="mt-2" />);
      const button = screen.getByRole("button");
