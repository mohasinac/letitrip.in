...
export default function SearchBar() {
  ...
  return (
    <div ref={searchRef} className="relative w-full max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          />
          {query && (
            <button
              type="button"
      ...
      {showResults && (
        <div className="absolute z-50 w-full mt-2 bg-white rounded-lg shadow-lg border max-h-[500px] overflow-y-auto">
          {/* Loading State */}
          {loading && (
                  ...
                  <div className="space-y-1">
                    {results.products.map((product: any) => (
                      <button
                        ...
                        className="w-full flex items-center gap-3 p-2 hover:bg-gray-50 rounded"
                      >
                        {product.images?.[0] && (
                          <img
