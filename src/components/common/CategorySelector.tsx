            ...
            >
              ...
              <span
                className={`flex-1 text-sm ${
                  !canSelect ? "font-semibold text-gray-700" : ""
                }`}
              >
                {category.name}
              </span>
  ...
  return (
    <div className={`category-selector relative ${className}`}>
      ...
      <div
        ...
        className={`
          flex items-center gap-2 px-3 lg:px-4 h-full cursor-pointer bg-transparent hover:bg-gray-50 transition-colors
      ...
      {isOpen && (
        <>
          ...
          {/* Dropdown content */}
          <div className="absolute z-20 left-0 top-full mt-1 w-80 bg-white border border-gray-200 rounded-lg shadow-xl max-h-96 overflow-hidden flex flex-col">
            {/* Search */}
            <div className="p-3 border-b border-gray-100 bg-gray-50">
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-white focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 outline-none transition-all"
              />
            </div>
            ...
            {/* Helper text */}
            {!allowParentSelection && (
              <div className="px-3 py-2 text-xs text-gray-600 border-t border-gray-100 bg-gray-50">
