    ...
    <div>
      ...
      >
        ...
        <Button
          ...
          onClick={onToggle}
          className={`
            flex-shrink-0 w-5 h-5 ${flex.center} text-zinc-500 hover:text-zinc-700 dark:hover:text-zinc-300
        ...
        <div className="relative flex-shrink-0 w-7 h-7 rounded overflow-hidden">
          {node.display?.coverImage ? (
            ...
            <div
              className={`w-full h-full ${flex.center} text-sm`}
        ...
        <div className="flex items-center gap-1">
          ...
          {onDelete && (
            <Button
              ...
              className="p-1.5 text-zinc-500 hover:text-red-600 dark:hover:text-red-400 rounded hover:bg-zinc-100 dark:hover:bg-slate-700"
