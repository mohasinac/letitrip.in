...
import { adminAdjustRCAction } from "@/actions";
...
const { position, flex, themed } = THEME_CONSTANTS;
...
export function RCAdjustModal({
  user,
  isOpen,
  onClose,
  onSuccess,
}: RCAdjustModalProps) {
  const t = useTranslations("adminRC");
        ...
        >
          ...
          >
            ...
            <Text weight="semibold">
              {(user.rcBalance ?? 0).toLocaleString()} {t("coins")}
            </Text>
          </div>
