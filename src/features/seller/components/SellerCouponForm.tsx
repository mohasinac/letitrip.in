      ...
      <Card className="p-6">
        ...
        >
          <AccordionItem
            ...
            title={
              <Text className="font-semibold">{t("formSectionBasic")}</Text>
            }
          >
          ...
          <AccordionItem
            ...
            title={
              <Text className="font-semibold">{t("formSectionDiscount")}</Text>
            }
          >
            <FormGroup columns={2} className="pt-3">
              {/* Type */}
          ...
          <AccordionItem
            ...
            title={
              <Text className="font-semibold">{t("formSectionUsage")}</Text>
            }
          >
            <FormGroup columns={2} className="pt-3">
              <div>
          ...
          <AccordionItem
            ...
            title={
              <Text className="font-semibold">{t("formSectionValidity")}</Text>
            }
          >
            <FormGroup columns={2} className="pt-3">
              <div>
