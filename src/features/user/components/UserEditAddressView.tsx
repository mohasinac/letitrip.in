 ...
 * Extracted from src/app/[locale]/user/addresses/edit/[id]/page.tsx (was 150 lines).
 * Edit and delete a saved address for the authenticated user.
 */
...
export function UserEditAddressView() {
