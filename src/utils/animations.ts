...
export class ParallaxEffect {
  private elements: Map<Element, { speed: number; initialY: number }> = new Map();
 ...
 */
export const optimizedProperties = [
  'transform',
  'opacity',
  'filter',
] as const;
 ...
 */
export function addWillChange(element: HTMLElement, properties: string[]): () => void {
