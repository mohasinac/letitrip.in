...
const sampleProducts = [
  {
    ...
    description:
      "Professional-grade battle axe with lightning-fast strike capabilities. Engineered for competitive battles with superior balance and durability.",
    price: 299.99,
  ...
  },
  {
    ...
    description:
      "Complete protective armor set with dragon scale pattern. Provides maximum protection while maintaining flexibility for combat movements.",
    price: 599.99,
  ...
  },
  {
    ...
    description:
      "Premium booster pack containing 15 randomly selected Mystic Crystal trading cards including rare holographic cards.",
    price: 24.99,
    originalPrice: 29.99,
  ...
  },
  {
    ...
    description:
      "Highly detailed collectible figurine of the legendary hero Azurion. Hand-painted with premium materials and authentic battle pose.",
    price: 89.99,
  ...
  },
  {
    ...
    description:
      "Advanced strategy board game for 2-6 players. Features complex tactical gameplay with over 200 unique game pieces and modular board.",
    price: 79.99,
    originalPrice: 99.99,
  ...
  },
  {
    ...
    description:
      "Professional gaming headset with 7.1 surround sound, noise cancellation, and ergonomic design for extended gaming sessions.",
    price: 149.99,
