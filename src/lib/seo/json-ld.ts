...
// ─── Lightweight input types (avoid importing heavy DB documents) ─────────────
...
/**
 * Aggregate rating structured data (Schema.org AggregateRating)
 * Embed inside a productJsonLd or use standalone.
 */
...
/**
 * Blog post structured data (Schema.org BlogPosting)
 */
 ...
 * Typically injected in the root layout once.
 */
...
/**
 * Sitelinks SearchBox structured data (Schema.org WebSite)
 * Inject in root layout to enable Google Sitelinks search box.
 */
...
/**
 * Auction structured data (Schema.org Product + Auction)
 */
