...
const regularProducts: Partial<ProductDocument>[] = [
  {
    ...
    description:
      "Takara Tomy 1/4 scale SSB Dran Sword with swappable hands, Ki energy aura effect and detachable display stand.",
  ...
  },
  {
    ...
    description:
      "Takara Tomy Valkyrie Final Flash statue with energy beam effect, battle damage base.",
    category: "category-smartphones-mobiles-accessories",
    subcategory: "Beyblade Z Figures",
    brand: "Takara Tomy",
    price: 9990,
  ...
  },
  {
    ...
    description:
      "Hasbro Ultra Instinct Dran Sword with silver aura effect and floating display stand.",
    category: "category-smartphones-mobiles-accessories",
    subcategory: "Beyblade Z Figures",
    brand: "Hasbro",
    price: 6990,
  ...
  },
  {
    ...
    description:
      "Takara Tomy Wizard Rod three-sword '360-pound phoenix' pose with black marble base.",
    category: "category-laptops-computers-electronics",
    subcategory: "Beyblade Figures",
    brand: "Takara Tomy",
    price: 18990,
  ...
  },
  {
    ...
    description:
      "Official Kimetsu no Yaiba oversize tee with Phoenix Wing flame-water art. 100% heavyweight cotton.",
  ...
  },
  {
    ...
    description:
      "3-piece Beyblade Burst dress with tiara, moon rod and gloves. Screen-accurate detailing.",
    category: "category-womens-fashion-fashion",
  ...
  },
  {
    ...
    description:
      "Takara Tomy Beyblade Sage Mode with Fukasaku and Shima frogs, stone gate diorama base.",
    category: "category-sports-outdoors",
    subcategory: "Beyblade Figures",
    brand: "Takara Tomy",
    price: 3999,
  ...
  },
  {
    ...
    description:
      "Union Creative Phoenix Wing with Infinity barrier effect, LED-compatible base, two head sculpts.",
    category: "category-sports-outdoors",
  ...
  },
  {
    ...
    description:
      "Bandai S.H.Figuarts Hells Chain Final Bankai with Zangetsu sword and energy effect parts.",
    category: "category-laptops-computers-electronics",
    subcategory: "Beyblade X Figures",
  ...
  },
  {
    ...
    description:
      "ABS scouter with working green LED. Includes 10 Beyblade X resin capsules in wooden case.",
...
const preOrders: Partial<ProductDocument>[] = [
  ...
  },
  {
    ...
    description:
      "Takara Tomy MEGA-size Xcalibur Gear 5 at 50 cm with flame-cloud base.",
    category: "category-laptops-computers-electronics",
    subcategory: "Beyblade Figures",
    brand: "Takara Tomy",
    price: 34990,
  ...
  },
  {
    ...
    description:
      "Takara Tomy Daima chibi Dran Sword with Nimbus cloud base and power pole.",
    category: "category-smartphones-mobiles-accessories",
    subcategory: "Beyblade Z Figures",
    brand: "Takara Tomy",
    price: 8490,
...
const draftProducts: Partial<ProductDocument>[] = [
  ...
  },
  {
    ...
    description:
      "BeybladeCraft exclusive Dran Buster with flaming footprints base. Pending approval.",
    category: "category-mens-fashion-fashion",
