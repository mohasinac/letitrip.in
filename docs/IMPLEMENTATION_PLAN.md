...
| **36** | 🔄 In Progress | 2026-02-27 | --         | Admin pages i18n wiring batch 2 — `admin/users`, `admin/products`, `admin/orders`, `admin/reviews`, `admin/bids`, `admin/blog`, `admin/categories`, `admin/faqs`, `admin/carousel`, `admin/sections`, `admin/coupons`, `admin/events`, `admin/events/[id]/entries`. All remaining `UI_LABELS.ADMIN.*` replaced.                                                                                                                                                                                                                                                                                                                                                                                               |
