...
| **37** | 🔄 In Progress | 2026-02-28 | --         | Service Layer Migration — 37.1–37.13 ✅ complete. 37.14 (oversized pages) partial: `profile/[userId]` 545→75, `sellers/[id]` 433→67, `seller/products` 431→184, `user/orders/[id]/track` 394→71, `admin/reviews` 391→11, `admin/products` 329→11, `admin/categories` 325→15, `admin/faqs` 309→15, `auctions/[id]` 305→15, `admin/analytics` 301→12, `admin/blog` 292→12, `checkout` 287→12, `admin/sections` 269→18, `admin/users` 268→18, `admin/coupons` 266→18, `admin/carousel` 261→12, `categories/[slug]` 260→12, `admin/bids` 254→12, `search` 252→9, `products` 245→9, `user/orders/view/[id]` 235→4, `admin/payouts` 232→4, `admin/newsletter` 228→4, `auth/reset-password` 224→16. New views: `PublicProfileView`, `SellerStorefrontView`, `OrderTrackingView`, `AdminReviewsView`, `AdminProductsView`, `AdminCategoriesView`, `AdminFaqsView`, `AuctionDetailView`, `AdminAnalyticsView`, `AdminBlogView`, `CheckoutView`, `AdminSectionsView`, `AdminUsersView`, `AdminCouponsView`, `AdminCarouselView`, `AdminBidsView`, `CategoryProductsView`, `SearchView`, `ProductsView`, `OrderDetailView`, `AdminPayoutsView`, `AdminNewsletterView`, `ResetPasswordView`. New hooks: `usePublicProfile`, `useSellerStorefront`, `useCountdown`. Feature modules: `src/features/seller/`, `src/features/admin/`, `src/features/categories/`, `src/features/search/`, `src/features/products/`, `src/features/user/`, `src/features/auth/`. 0 TS errors. Remaining: ~9 more oversized pages. |
