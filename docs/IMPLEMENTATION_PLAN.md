...
| **37** | 🔄 In Progress | 2026-02-28 | --         | Service Layer Migration — 37.1–37.13 ✅ complete. 37.14 (oversized pages) partial: `profile/[userId]` 545→75, `sellers/[id]` 433→67, `seller/products` 431→184, `user/orders/[id]/track` 394→71, `admin/reviews` 391→11, `admin/products` 329→11, `admin/categories` 325→15, `admin/faqs` 309→15, `auctions/[id]` 305→15, `admin/analytics` 301→12, `admin/blog` 292→12, `checkout` 287→12. New views: `PublicProfileView`, `SellerStorefrontView`, `OrderTrackingView`, `AdminReviewsView`, `AdminProductsView`, `AdminCategoriesView`, `AdminFaqsView`, `AuctionDetailView`, `AdminAnalyticsView`, `AdminBlogView`, `CheckoutView`. New hooks: `usePublicProfile`, `useSellerStorefront`, `useCountdown`. Feature modules: `src/features/seller/`, `src/features/admin/`. 0 TS errors. Remaining: ~21 more oversized pages. |
