...
| **37** | 🔄 In Progress | 2026-02-28 | --         | Service Layer Migration — 37.1–37.13 ✅ complete. 37.14 (oversized pages) partial: `profile/[userId]` 545→75 lines, `sellers/[id]` 433→67 lines, `seller/products` 431→184 lines, `user/orders/[id]/track` 394→71 lines, `admin/reviews` 391→11 lines, `admin/products` 329→11 lines. New: `PublicProfileView`, `SellerStorefrontView`, `usePublicProfile`, `useSellerStorefront`, `OrderTrackingView`, `AdminReviewsView`, `AdminProductsView`; `src/features/seller/` + `src/features/admin/` modules added. 0 TS errors. Remaining: ~27 more oversized pages.                                                                                                                                              |
