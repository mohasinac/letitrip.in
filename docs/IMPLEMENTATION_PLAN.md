...
| **19**                                                                                                                          | 🔄 In Progress | 2026-02-28 | --         | 19.1 ✅ Service tests — 27 test files (176 tests across all 26 services). 19.2 ✅ Admin events API tests — `admin-events.test.ts` (24 tests). 19.3 ✅ Public events API tests — `public-events.test.ts` (15 tests). 19.4 ✅ Missing API tests — `cart.test.ts` (16), `checkout.test.ts` (8), `notifications.test.ts` (12), `promotions.test.ts` (6) — 42 tests, 4 files. 19.5 ✅ Public events page tests — `events/page.test.tsx` (4), `events/[id]/page.test.tsx` (4), `events/[id]/participate/page.test.tsx` (3) — 11 tests, 3 files. 19.6 ✅ Admin events page tests — `admin/events/page.test.tsx` (5), `admin/events/[id]/entries/page.test.tsx` (6) — 11 tests, 2 files. 19.7 ✅ User & seller page tests — `user/notifications/page.test.tsx` (4), `user/orders/[id]/track/page.test.tsx` (4), `seller/products/[id]/edit/page.test.tsx` (4) — 12 tests, 3 files. 19.8 ✅ Events public component tests — EventCard (6), EventStatusBadge (4), EventLeaderboard (5), PollVotingSection (4), FeedbackEventSection (3), SurveyEventSection (5) — 27 tests, 6 files. 19.9 ✅ Events admin component + hook tests — EventsTable (4), EventStatsBanner (5), EventEntriesTable (3), EntryReviewDrawer (3), SurveyFieldBuilder (5), useEvents (3), useEvent (4), usePublicEvents (3), useEventStats (3), useEventMutations (4), useEventEntries (4), useEventLeaderboard (3) — 44 tests, 12 files. Sub-phase 19.10 pending. Total so far: 373 new tests, 62 new files. |
