...
| **37** | 🔄 In Progress | 2026-02-28 | --         | Service Layer Migration — 37.1–37.13 ✅ complete. 37.14 (oversized pages) partial: `profile/[userId]` 545→75 lines, `sellers/[id]` 433→67 lines, `seller/products` 431→184 lines. New: `PublicProfileView`, `SellerStorefrontView`, `usePublicProfile`, `useSellerStorefront`, `src/features/seller/` module with `useSellerProducts` + `SellerProductCard`. 0 TS errors. Remaining: 30+ more oversized pages.                                                                                                                                                                                                                                                                                                |
