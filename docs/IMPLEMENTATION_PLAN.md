...
| **35** | ⬜ Not started | --         | --         | Admin pages i18n wiring batch 1 — `admin/dashboard`, `admin/analytics`, `admin/media`, `admin/newsletter`, `admin/payouts`, `admin/site`. `adminDashboard.*`, `adminAnalytics.*`, `adminMedia.*`, `adminNewsletter.*`, `adminPayouts.*`, `adminSite.*` namespaces added.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **36** | ⬜ Not started | --         | --         | Admin pages i18n wiring batch 2 — `admin/users`, `admin/products`, `admin/orders`, `admin/reviews`, `admin/bids`, `admin/blog`, `admin/categories`, `admin/faqs`, `admin/carousel`, `admin/sections`, `admin/coupons`, `admin/events`, `admin/events/[id]/entries`. All remaining `UI_LABELS.ADMIN.*` replaced.                                                                                                                                                                                                                                                                                                                                                                                               |
