...
| ~~90~~                                                                                                 | ~~`src/app/[locale]/admin/site/page.tsx`~~                   | 10                                                                                  | ✅ DONE — 4 lines, AdminSiteView                                                          |
| ~~91~~                                                                                                 | ~~`src/app/[locale]/user/notifications/page.tsx`~~           | 10                                                                                  | ✅ DONE — 4 lines, UserNotificationsView                                                  |
| ~~92~~                                                                                                 | ~~`src/app/[locale]/admin/events/page.tsx`~~                 | 10                                                                                  | ✅ DONE — 4 lines, AdminEventsView                                                        |
| ~~93~~                                                                                                 | ~~`src/app/[locale]/user/addresses/edit/[id]/page.tsx`~~     | 10                                                                                  | ✅ DONE — 4 lines, UserEditAddressView                                                    |
| **WAVE 5 — Newly discovered violations** (re-run #4 audit, 2026-03-02)                                 |                                                              |                                                                                     |
| ~~94~~                                                                                                 | ~~`src/components/user/addresses/AddressCard.tsx`~~          | 7,31                                                                                | ✅ DONE — Heading/Text already in place                                                   |
| ~~95~~                                                                                                 | ~~`src/features/seller/components/SellersListView.tsx`~~     | 7,31                                                                                | ✅ DONE — Heading/Text already in place                                                   |
| ~~96~~                                                                                                 | ~~`src/components/user/orders/OrderTrackingView.tsx`~~       | 7,31                                                                                | ✅ DONE — 4 raw p tags → Text/Caption; tests updated                                      |
| ~~97~~                                                                                                 | ~~`src/components/user/notifications/NotificationItem.tsx`~~ | 7,31                                                                                | ✅ DONE — Text already in place                                                           |
| ~~98~~                                                                                                 | ~~`src/features/products/components/ProductDetailView.tsx`~~ | 7,31                                                                                | ✅ DONE — Heading/Text already in place                                                   |
| ~~99~~                                                                                                 | ~~`src/components/user/addresses/AddressForm.tsx`~~          | 7,8,31                                                                              | ✅ DONE — Checkbox and Label already in place                                             |
| ~~100~~                                                                                                | ~~`src/components/user/profile/ProfileStatsGrid.tsx`~~       | 7,31                                                                                | ✅ DONE — Text already in place                                                           |
| ~~101~~                                                                                                | ~~`src/components/user/settings/EmailVerificationCard.tsx`~~ | 7,31                                                                                | ✅ DONE — Heading/Text already in place                                                   |
| ~~102~~                                                                                                | ~~`src/components/user/settings/PhoneVerificationCard.tsx`~~ | 7,31                                                                                | ✅ DONE — Heading/Text already in place                                                   |
| ~~103~~                                                                                                | ~~`src/components/ui/AddressSelectorCreate.tsx`~~            | 7,31                                                                                | ✅ DONE — Label already in place                                                          |
| ~~104~~                                                                                                | ~~`src/components/utility/Search.tsx`~~                      | 7,31                                                                                | ✅ DONE — Text already in place                                                           |
| ~~105~~                                                                                                | ~~`src/components/ui/FilterFacetSection.tsx`~~               | 7,31                                                                                | ✅ DONE — Text already in place                                                           |
