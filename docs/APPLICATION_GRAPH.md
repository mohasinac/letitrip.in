...
##### D.2 — ✅ Index coverage by collection (all gaps resolved — TASK-30, TASK-31, TASK-32, TASK-33, TASK-38)

> **All ⚠️ and ❌ statuses below have been resolved.** This table reflects the state _before_ TASK-30–33 were applied. It is kept for historical reference. The `firestore.indexes.json` now includes all missing/corrected entries (TASK-30–33 added 27 entries; TASK-38 added `coupons: type+createdAt`).
...
| `coupons`                 | validity.isActive+validity.startDate, validity.isActive+validity.endDate, type+validity.isActive, createdBy+validity.startDate, **type+createdAt** ✅ TASK-38                                        | —                                                                                                                                                                             | ✅     |
