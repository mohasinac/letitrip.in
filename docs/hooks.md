...
## Admin List Hooks (`features/admin/hooks/`)

Paginated admin list hooks are generated by `createAdminListQuery`, a shared factory that handles URLSearchParams parsing, `useQuery` wiring, and `staleTime` defaults.

| Hook                            | Factory? | Mutations                                            |
| ------------------------------- | -------- | ---------------------------------------------------- |
| `useAdminOrders(sieveParams)`   | ✅       | `updateMutation`                                     |
| `useAdminUsers(sieveParams)`    | ✅       | `updateUserMutation`, `deleteUserMutation`           |
| `useAdminProducts(sieveParams)` | ✅       | `createMutation`, `updateMutation`, `deleteMutation` |
| `useAdminBlog(sieveParams)`     | ✅       | —                                                    |
| `useAdminBids(sieveParams)`     | ✅       | —                                                    |
| `useAdminCoupons(sieveParams)`  | ✅       | `createMutation`, `updateMutation`, `deleteMutation` |
| `useAdminPayouts(sieveParams)`  | ✅       | `updateMutation`                                     |
| `useAdminReviews(sieveParams)`  | ✅       | `updateMutation`, `deleteMutation`                   |
| `useAdminFaqs(sieveParams)`     | ✅       | `createMutation`, `updateMutation`, `deleteMutation` |
| `useAdminStores(sieveParams)`   | ✅       | `updateStoreMutation`                                |

Factory exports: `createAdminListQuery<TItem, TResult>()`, `extractBasicMeta()`, `AdminListMeta` type.

Other admin hooks (non-factory): `useAdminStats`, `useAdminAnalytics`, `useAdminCarousel`, `useAdminCategories`, `useAdminSections`, `useAdminSessions`, `useAdminSiteSettings`, `useAdminFeatureFlags`, `useAlgoliaSync`, `useDemoSeed`.
