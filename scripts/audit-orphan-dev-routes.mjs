 ...
 *
 * Track H deleted the orphaned `/api/dev/mock-*` HTTP routes wholesale (the
 * in-process mock Razorpay provider they backed was itself removed later).
 * This audit blocks any future route from being added under
 * `src/app/api/dev/`.
 *
