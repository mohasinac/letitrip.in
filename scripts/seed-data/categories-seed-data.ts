...
export const categoriesSeedData: Partial<CategoryDocument>[] = [
  ...
  // BRAND: Apple
  {
    ...
    metrics: {
      ...
      productIds: [
        "product-iphone-15-pro-max-smartphones-new-techhub-electronics-1",
        "product-macbook-pro-16-m3-max-laptops-computers-new-techhub-electronics-1",
        "product-airpods-pro-2nd-gen-audio-new-techhub-electronics-1",
      ],
      auctionCount: 2,
      auctionIds: [
        "auction-iphone15-sealed-bundle-techhub-1",
        "auction-macbook-pro-m3-auction-electronics-techhub-1",
      ],
      totalProductCount: 3,
      totalAuctionCount: 2,
      totalItemCount: 5,
    ...
    seo: {
      ...
      ogImage: "https://picsum.photos/seed/brand-apple/1200/630",
    },
    display: {
      icon: "🍎",
      coverImage: "https://picsum.photos/seed/brand-apple/800/800",
      color: "#555555",
      showInMenu: false,
      showInFooter: false,
    },
  ...
  // BRAND: Samsung
  {
    ...
    metrics: {
      ...
      productIds: [
        "product-samsung-galaxy-s24-ultra-smartphones-new-techhub-electronics-1",
        "product-samsung-55-qled-tv-new-homeessentials-1",
      ],
      auctionCount: 0,
      auctionIds: [],
      totalProductCount: 2,
    ...
    seo: {
      ...
      keywords: ["samsung", "galaxy", "qled", "samsung tv"],
      ogImage: "https://picsum.photos/seed/brand-samsung/1200/630",
    },
    display: {
      icon: "📺",
      coverImage: "https://picsum.photos/seed/brand-samsung/800/800",
      color: "#1428a0",
      showInMenu: false,
      showInFooter: false,
    },
  ...
  // BRAND: Sony
  {
    ...
    seo: {
      ...
      ogImage: "https://picsum.photos/seed/brand-sony/1200/630",
    },
    display: {
      icon: "🎮",
      coverImage: "https://picsum.photos/seed/brand-sony/800/800",
      color: "#000000",
      showInMenu: false,
      showInFooter: false,
    },
  ...
  // BRAND: Nike
  {
    ...
    seo: {
      ...
      ogImage: "https://picsum.photos/seed/brand-nike/1200/630",
    },
    display: {
      icon: "👟",
      coverImage: "https://picsum.photos/seed/brand-nike/800/800",
      color: "#111111",
      showInMenu: false,
      showInFooter: false,
    },
  ...
  // BRAND: Adidas
  {
    ...
    seo: {
      ...
      ogImage: "https://picsum.photos/seed/brand-adidas/1200/630",
    },
    display: {
      icon: "👕",
      coverImage: "https://picsum.photos/seed/brand-adidas/800/800",
      color: "#000000",
      showInMenu: false,
      showInFooter: false,
    },
