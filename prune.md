...
- **DONE (session 18 batch 2)**: cart item and promo surfaces now adopt `Row` variants in `CartItemRow.tsx`, `GuestCartItemRow.tsx`, and `PromoCodeInput.tsx` for repeated `flex items-center gap-*` bundles.
