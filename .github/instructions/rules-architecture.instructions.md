...
| `user`       | `src/features/user/`       | `ProfileView`, `UserOrdersView`, `OrderDetailView`, `UserNotificationsView`, `UserAddressesView`, `MessagesView`, `RipCoinsWallet`, `useUserOrders`, `useUserNotifications`               |
